<template>
  ...
  >
    ...
    >
      ...
      >
        <a v-if="index === 3" :href="item.link" style="color: #464646; font-weight: bold;" target="_blank">{{item.name}}</a>
        <a v-if="index !== 3" :href="item.link" target="_blank">{{item.name}}</a>
      </div>
    </div>
    ...
    <div
      ...
      <div class="share-wrapper">
        ...
        <div class="share-btn" @click="shareFacebook(projectHref)">
          <a>
            <img src="../assets/img/share_fb.svg" alt="">
          </a>
        </div>
        <div class="share-btn" @click="shareLine">
          <a>
            <img src="../assets/img/share_line.svg" alt="">
          </a>
        </div>
      </div>
    </div>
