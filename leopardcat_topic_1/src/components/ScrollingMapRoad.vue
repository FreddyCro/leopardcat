<template>
  ...
  >
    ...
    >
      <div
        class="svg-image-wrapper"
      >
        <MapSvg
          :layer1Flag = layer1Flag
          :layer2Flag = layer2Flag
          :layer3Flag = layer3Flag
        ></MapSvg>
      </div>
      ...
      if (this.useFadeFlag) {
        ...
        if (
          ...
          if (window.pageYOffset > document.getElementById(this.mapId).offsetTop + document.getElementById(this.mapId).offsetHeight * 0.2) {
            // this.layer1Flag = false;
            this.layer2Flag = true;
          }

          // 滑到圖片70%圖片移動變大
          if (window.pageYOffset > document.getElementById(this.mapId).offsetTop + document.getElementById(this.mapId).offsetHeight * 0.5) {
            this.layer3Flag = true;
          }
        } else {
          this.fadeFlag = false;
          this.layer2Flag = false;
          this.layer3Flag = false;
