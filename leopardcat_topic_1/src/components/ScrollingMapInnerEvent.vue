  ...
  >
    ...
    >
      <div class="overlap-image-wrapper">
        ...
        >
          <img :src="certifyDevice ? imgSrcWeb1 : imgSrcMob1" alt="">
        </div>
        <div :class="{
          'top-image': true,
          'image-fade-in': imageFadinFlag,
          'image-transformation': imageTransformationFlag,
          }"
        >
          <img :src="certifyDevice ? imgSrcWeb2 : imgSrcMob2" alt="">
        </div>
      </div>
    </div>
    <div
      ...
      if (this.useFadeFlag) {
        ...
        if (
          ...
          if (window.pageYOffset > document.getElementById(this.mapId).offsetTop + document.getElementById(this.mapId).offsetHeight * 0.3) {
            this.imageFadinFlag = true;
          }

          // 滑到圖片70%圖片移動變大
          if (window.pageYOffset > document.getElementById(this.mapId).offsetTop + document.getElementById(this.mapId).offsetHeight * 0.7) {
  ...
  .map-image-wrapper {
    ...
    .overlap-image-wrapper {
      ...
      .image-transformation {
        transform: translate(20%, 5%) scale(1.8);
